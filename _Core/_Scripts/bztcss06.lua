...
function AddObject(h)
	if (not IsAlive(x.farm) or x.farm == nil) and (IsOdf(h, "avarmoss06:1") or IsOdf(h, "abarmo06")) then
		x.farm = h
	elseif (not IsAlive(x.ffac) or x.ffac == nil) and (IsOdf(h, "avfactss06:1") or IsOdf(h, "abfactss06")) then
		x.ffac = h
